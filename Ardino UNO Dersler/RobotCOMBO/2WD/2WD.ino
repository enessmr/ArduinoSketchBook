...
void setup() {
  ...
  // göndermiş olduğu bu dalgaları Echo pini ile geri aldığı için INPUT yani (Giriş) olarak tanımlanır.
...
void ileri() {  // Robotun ileri yönde hareketi için fonksiyon tanımlıyoruz.
  ...
  analogWrite(MotorRenable, 250); // Sağ motorun hızı 250

  digitalWrite(MotorL1, HIGH); // Sol motorun ileri hareketi aktif
  digitalWrite(MotorL2, LOW); // Sol motorun geri hareketi pasif
  analogWrite(MotorLenable, 250); // Sol motorun hızı 250
}
